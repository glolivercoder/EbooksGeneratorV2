            ...
            <div className="settings-content">
                ...
                <div className="setting-group">
                    <label htmlFor="openai">
                        ...
                        <span className="label-hint">Para acesso aos modelos GPT</span>
                    </label>
                    <input
                        id="openai"
                        type="password"
                    ...
                    />
                    <small className="help-text">
                        Obtenha em: <a href="https://platform.openai.com" target="_blank" rel="noopener noreferrer">platform.openai.com</a>
                    </small>
                </div>
